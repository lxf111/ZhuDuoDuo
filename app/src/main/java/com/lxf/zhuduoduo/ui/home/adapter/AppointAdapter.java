...
public class AppointAdapter extends RecyclerView.Adapter<AppointAdapter.ViewHolder> {
    ...
    public AppointAdapter(Activity context, List<ToastListBean.DataBean.GoodsBean> bean) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.item_appoint, null);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.tvAppoint.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(context, "一分预约", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    protected class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            tvAppoint = (TextView) view.findViewById(R.id.tv_appoint);
        }
    }
}
