...
import com.lxf.zhuduoduo.ui.home.adapter.FreeAdapter;
...
public class FreeActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        tabToast.setSelectedTabIndicatorColor(getResources().getColor(R.color.theme));
    }

    private void getData() {
        String json = "{\"type\":\"22\",\"nowPage\":\"" + nowPage + "\"" +
            ...
            public void onRequestComplete(String response, String msg, String code) {
                ...
                if (code.equals("0")) {
                    if (nowPage == 1) {
                        ...
                        adapter = new FreeAdapter(FreeActivity.this, resultBean.getData().getGoods());
