...
import com.lxf.zhuduoduo.popup.adapter.CityPopAdapter;
...
public class CityPop extends PopupWindow {
    ...
    public CityPop(final Context context, ListView.OnItemClickListener onItemClickListener, BrandBean model) {
        super(context);
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        view = inflater.inflate(R.layout.pop_city, null);

        listView = view.findViewById(R.id.list_city);
        adapter = new CityPopAdapter(context, model);
